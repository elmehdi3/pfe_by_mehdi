...
class AdminController(
    ...
    fun banUser(@PathVariable id: Long, @RequestParam(required = false) reason: String?): ResponseEntity<ApiResponse<Void>> {
        moderationService.banUser(id, reason)
        return ResponseEntity.ok(ApiResponse.success(null, "Utilisateur banni avec succès"))
    }
